...
public class DatabaseConnection 
{
		...
		try
		{
			...
			if(this.URL.contains("postgres")||this.URL.contains("mysql")){
				...
				if(this.user.toLowerCase().equals("integratedsecurity"))
					...
					URL +=";databaseName="+this.database+";integratedSecurity=true;";
				else
					//URL +=";databaseName="++";user="+this.user+";password="+this.passwd;
					URL +=";databaseName="+this.database+";user="+this.user+";password="+this.passwd;
	...
	public boolean checkTableExists(String table)
	{
		...
		String query = "SELECT COUNT(*) AS MYCOUNT " +
	...
	{
		ResultSet sqlResults = getTableQuery("SELECT COUNT(*) AS MYCOUNT FROM " + table + " ;");
