...
public class MiscTests 
{
	...
	{
		// New BloomFilter
		BloomFilter<String> b0 = new BloomFilter<String>(100, 30, null);
		BloomFilter<String> b1 = new BloomFilter<String>(100, 11, null);
		String s = "BrandonAbb";
		// Add 11 elements to each
		b0.addAsBigrams(s, null);
		b1.addAsBigrams(s, null);
		...
		BloomFilter<String> b2 = new BloomFilter<String>(1000, 23, null);
