...
public class BloomFilter<E> implements Serializable {
     ...
     * c*n.
      ...
      */
    public BloomFilter(double c, int n, int k, String[] parSalts) {
     ...
     */
    public BloomFilter(int bitSetSize, int expectedNumberOElements, String[] parSalts) {
        this(bitSetSize / (double)expectedNumberOElements,
             expectedNumberOElements,
             (int) Math.round((bitSetSize / (double)expectedNumberOElements) * Math.log(2.0)), parSalts);
    }
     ...
     */
    public BloomFilter(double falsePositiveProbability, int expectedNumberOfElements, String[] parSalts) {
        this(Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))) / Math.log(2), // c = k / ln(2)
             expectedNumberOfElements,
             (int)Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))), parSalts); // k = ceil(-log_2(false prob.))
    }
     ...
     */
    public BloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData, String[] parSalts) {
        this(bitSetSize, expectedNumberOfFilterElements, parSalts);
     ...
     */
    public void add(E element, String[] parSalts) {
       long hash;
       ...
       for (int x = 0; x < k; x++) 
       {
    	   ...
    	   MyUtilities.set_Salts(parSalts);
     ...
     */
    public void addAsBigrams(E element, String[] parSalts)
    {
     ...
     */
    public void addAll(Collection<? extends E> c, String[] parSalts) {
        for (E element : c)
            add(element, parSalts);
    }
